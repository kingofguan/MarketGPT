"""
main training script. Based on the original othello_mamba train.py, but with a few modifications. https://github.com/alxndrTL/othello_mamba/blob/main/train.py
