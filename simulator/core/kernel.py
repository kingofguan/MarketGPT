...
class Kernel:
    ...
    def __init__(
        ...
        # # Filter for any Gym agents - does not require dependency on gym.
        ...
        # # Temporary check until gym supports multiple gym agents
        # assert (
        #     len(self.gym_agents) <= 1
        # ), "gym currently only supports using one gym agent"

        # logger.debug(f"Detected {len(self.gym_agents)} gym agents")
